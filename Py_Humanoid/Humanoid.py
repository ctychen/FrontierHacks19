...
class Humanoid():
    ...
    def walkForward(self):
        ...
        leftAnkle.rotateTo(70-20)   #L ANKLE

        time.sleep(0.25)

        rightThigh.rotateTo(95+20)   #L ANKLE
        # "back" =
        # "forward" =
        #start at 120
        #decreases to 100 -> brings body back
        #

        rightKnee.rotateTo(120)   #L ANKLE
        leftThigh.rotateTo(125+40)   #L ANKLE
        # "back" =
        # "forward" =
        #start at 120
